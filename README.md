...
The Terminal, Crash-Test and Activity Monitor have moved across that boundary. It is a separately compiled program
...
The caveat that remains: the other eleven applications still run in Ring 0 as
...
| Activity Monitor (Ring 3) | CPU/memory/process table, all via syscall |
...
keeps advancing under load. 27 test functions across 25 modules:
